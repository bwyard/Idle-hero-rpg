...
import type { Region, AdventurerTier, QuestDifficulty } from '@idle-hero-rpg/shared';
import {
...
export interface QuestTemplate {
   ...
   * 1 = solo (fully supported). 2–3 = party (future extension — see Quest.partySize).
   */
...
export const QUEST_TEMPLATES: Record<string, QuestTemplate> = {
  ...
  'quest-tpl-wilds-beast': {
    ...
    region: 'Wilds',
    minTier: 'C',
    // partySize: 2 — future: party assignment not yet implemented; solo for now.
    partySize: 1,
    difficulty: 'hard',
    baseDurationDays: PLACEHOLDER_QUEST_DURATION_DAYS,
    baseGoldReward: PLACEHOLDER_QUEST_GOLD_REWARD,
  ...
  'quest-tpl-capital-tournament': {
    ...
    region: 'CapitalRegion',
    minTier: 'B',
    // partySize: 3 — future: party assignment not yet implemented; solo for now.
    partySize: 1,
    difficulty: 'legendary',
    baseDurationDays: PLACEHOLDER_QUEST_DURATION_DAYS,
    baseGoldReward: PLACEHOLDER_QUEST_GOLD_REWARD,
